...
(function($) {
    ...
    $(".topLogo").hover(function() {
        $( '#jmaclogo' ).attr("src","https://www.jmacman.com/wp-content/themes/base/dist/img/jmacman\-logo2.png");
        $('.site-name').css("color","rgba(252, 170, 103, 1)");
    }, function() {
        $( '#jmaclogo' ).attr("src","https://www.jmacman.com/wp-content/themes/base/dist/img/jmacman\-logo.png");
